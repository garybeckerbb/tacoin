...
uint256 hashGenesisBlock("0xa275fcffababa5a19c085e9027a45a238dba8a6273e53a9bd303a19667ae4f73");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 10000); // Tacoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Tacoin: 1 days
static const int64 nTargetSpacing = 5 * 60; // Tacoin: 5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x958d748e42a9ff5d76e8b6cdf18c9dbcc7b6b0030ebd5a688cd8222533fccc55");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Turkey sentences journalists to life in jail over coup attempt";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1518795856;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085620150;

        if (fTestNet)
        {
            block.nTime    = 1518795834;
            block.nNonce   = 385372267;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x0ef428456f833124e4e1e83a0e2f05b52589c3768f8a499473a0fb424e31d9f3"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xf1, 0xcb, 0xb5, 0xdc }; // Tacoin: increase each by adding 2 to bitcoin's value.
